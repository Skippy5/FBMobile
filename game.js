class Game {
    ...
    bindEvents() {
        ...
        window.addEventListener('keydown', (e) => {
            ...
            // Interaction key
            if (e.key === 'e' || e.key === 'E' || e.key === ' ') this.rj.interacting = true;
            
            // Token usage key
            if (e.key === 't' || e.key === 'T') this.useToken();
        });
        ...
        window.addEventListener('keyup', (e) => {
            ...
            // Interaction key
            if (e.key === 'e' || e.key === 'E' || e.key === ' ') this.rj.interacting = false;
        });
        
        // Mobile controls - Touch events
        this.setupMobileControls();
        
        // Canvas touch controls for splash screen
        this.canvas.addEventListener('touchstart', (e) => {
            e.preventDefault(); // Prevent default touch behavior
            
            // If splash screen is showing, any touch will dismiss it and start the game
            if (this.showSplashScreen) {
                this.showSplashScreen = false;
                this.start(); // Start the game when the canvas is touched
                return;
            }
        ...
        // Handle touch events for level splash screen
